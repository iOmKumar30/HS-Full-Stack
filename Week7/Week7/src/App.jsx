...
function MyApp() {
  ...
  return (
    <div className="top-bar">
      <ButtonWithNotification label="My Network" count={networkCount.network >= 100 ? "99+" : networkCount.network} />
      ...
      <ButtonWithNotification label="Notifications" count={networkCount.notifications} />
